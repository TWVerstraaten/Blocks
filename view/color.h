...
namespace view::color {
    ...
    static const QColor TEXT_ERROR                         = {200, 50, 50, 255};
    static const QColor BACKGROUND                         = {8, 33, 73, 255};
    static const QColor PLAYABLE                           = {35, 123, 193, 255};
    static const QColor START                              = {119, 181, 230, 255};
    static const QColor SPLICE                             = {230, 181, 119, 255};
    static const QColor CONWAY                             = {21, 231, 32, 255};
    ...
    static const QColor WIDGET_LIGHT                       = {210, 210, 255, 255};
